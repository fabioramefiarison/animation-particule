var w,h,loopId,canvas,ctx,particles,id;
...
function linkPoints (point,hubs){
    for (var i = 0; i<hubs.length;i++){
        ...
        var opacite = 1 - distance / options.linkRadius;
        if (opacite > 0){
            ctx.lineWidth = 0.5
            ctx.strokeStyle = 'rgba('+rgb[0]+','+rgb[1]+','+rgb[2]+','+opacite+')'
            ctx.beginPath()
